...
CODE_START_ADDR = 0              # code region goes from 0x000 to 0x1fff
CODE_END_ADDR = 0x1fff           # code region goes from 0x000 to 0x1fff
...
DEVID_PIC16F877 = 0b00_1001_101  # device ID for PIC16F877
...
print(f"[2] Trying to find PIC16F877... ", end='')
found = False
devid, devrev = find_target()
if devid == DEVID_PIC16F877:
